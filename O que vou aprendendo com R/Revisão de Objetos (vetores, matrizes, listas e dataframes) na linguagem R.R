# Revisão de Fundamentos da linguagem R
...
!mat1>2&mat1<4 #verifica os valores que não são maiores que 2, mas que são
#menores que 4
#usando um loop for
...
mat2[sample(1:50,10)] = NA #dos valores de 1 a 50, de forma aleatória, serão 
#escolhidos 10 elementos para serem NA
mat2

na_lista = is.na(mat2) #matriz com valores TRUE e FALSE, onde TRUE são 
#os valores NA
na_lista
...
mtcars$hp #coluna 'hp'
subset(mtcars, subset=hp>170) #criando um subdataset onde os valores de hp são
#maiores que 170
library(dplyr) #importando o pacote dplyr
slice(mtcars, 1:4) #criand um subdataset com as linhas de 1 a 4
