#Família Aplly na linguagem R

#As funções da família apply() são uma forma de gerar loop for de forma mais 
#estilizada, pois loops for em R não são muito bons.
...
sapply(lista1, sum) #aplicando uma função nos elementos da lista
#função soma
sapply(lista1, mean)
#função média
...
escola$Media = apply(escola[,c(2,3,4)],1,mean) #substituindo valores pela média
#com a função apply
