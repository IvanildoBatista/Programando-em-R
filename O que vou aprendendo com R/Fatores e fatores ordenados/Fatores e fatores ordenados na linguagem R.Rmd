---
title: "Fatores e fatores ordenados"
...
Serve para armazenar variáveis categóricas (nominais e ordinais) e usa-se a função factor()
...
fac_vec2
levels(fac_vec2) = c('Femea','Macho') #atribuindo outros valores aos níveis do fator
