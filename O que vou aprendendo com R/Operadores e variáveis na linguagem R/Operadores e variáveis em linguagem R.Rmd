---
title: "Operadores e Variáveis em linguagem R"
...
as.integer('4.27') #também é possível arredondar string, desde que seus componentes sejam números
```
...
sqrt(as.complex(-1))#é possível converter um número negativo para complexo e tirar sua raiz quadrada
```
...
var2 = as.integer(var1)#atribuindo a uma variável outra variável, mas modificando o seu tipo para inteiro
var2
...
var5 = as.character(var1) #atribuindo outra variável, mas modificando o seu tipo para caracter
var5
mode(var5)
```
